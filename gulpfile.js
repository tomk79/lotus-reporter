...
// lotus-reporter.js (frontend) を処理
gulp.task("lotus-reporter.js", function() {
	return webpackStream({
		mode: 'production',
		entry: "./src/lotus-reporter.js",
		devtool: 'source-map',
		output: {
			filename: "lotus-reporter.js"
		},
		module:{
			rules:[
				{
...
// lotus-reporter.js (frontend) を処理
gulp.task("lotus-reporter.min.js", function() {
	return webpackStream({
		mode: 'production',
		entry: "./src/lotus-reporter.js",
		devtool: 'source-map',
		output: {
			filename: "lotus-reporter.min.js"
		},
		module:{
			rules:[
				{
